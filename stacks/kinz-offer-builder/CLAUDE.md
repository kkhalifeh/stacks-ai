...
1. Create a `.tsx` file under `pages/<group-id>/` with one or more named exports.
2. Register the component names in `stack.json` under the matching group's `sections[].components` array.
